...
abstract class $TokenModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? token, int? expiredIn});
}
...
class _$_TokenModel extends _TokenModel {
  _$_TokenModel({this.token, this.expiredIn}) : super._();
  ...
  @override
  String toString() {
    return 'TokenModel(token: $token, expiredIn: $expiredIn)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, expiredIn);
...
abstract class _TokenModel extends TokenModel {
  factory _TokenModel({final String? token, final int? expiredIn}) =
      _$_TokenModel;
